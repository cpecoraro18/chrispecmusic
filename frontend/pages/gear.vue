...
const gearTypes = ['', 'Bass', 'Amp', 'Cabinet', 'Pedal', 'Pedalboard', 'Power Supply', 'Microphone'];
const gearItems = ref([
  ...
  { name: 'Fender American Standard P Bass', type: 'Bass', image: '/img/gear/Fender-P-Bass.png', description: 'Classic Precision Bass tone with the reliability to match.' },
  ...
  { name: 'Knilling Bucharest Upright Bass', type: 'Bass', image: '/img/gear/Knilling-Upright.png', description: 'Go-to for jazz sessions and acoustic sets.' },
  { name: 'Markbass Little Mark 3 Amp', type: 'Amp', image: '/img/gear/Markbass-Little-Mark-3.png', description: 'Lightweight, powerful head with a clean, punchy sound.' },
  ...
  { name: 'Markbass 4x10 Cab', type: 'Cabinet', image: '/img/gear/Markbass-4x10.png', description: 'Big, punchy lows and clean mids for live shows.' },
  { name: 'Markbass New York 121 Cab', type: 'Cabinet', image: '/img/gear/Markbass-NewYork-121.png', description: 'Compact cab that still brings the warmth and punch. I own two of these for a flexible live sound options.' },
  { name: 'Tonebone Bass Preamp by Radial', type: 'Pedal', image: '/img/gear/Radial-Bassbone-V2.png', description: 'DI and preamp for fast switching between upright and electric bass.', link: 'https://amzn.to/3MDDMBR' },
  { name: 'Origin Effects Bass Rig Super Vintage', type: 'Pedal', image: '/img/gear/Origin-Effects-BassRig-Super-Vintage.png', description: 'SVT-style tones with tube-like feel and grit.' },
  { name: 'JHS Colour Box V2', type: 'Pedal', image: '/img/gear/JHS-ColorBox.webp', description: 'Flexible preamp that goes from clean to driven tones easily.' },
  ...
  { name: 'Damnation Audio MBD', type: 'Pedal', image: '/img/gear/MBD.png', description: 'Bass distortion with depth and blend knob to maintain lowend' },
  ...
  { name: 'Cioks DC7 Battery', type: 'Power Supply', image: '/img/gear/Cioks-DC7.png', description: 'Quiet, low-profile power supply that handles a full board with ease.', link: 'https://amzn.to/4d9uvMI' },
