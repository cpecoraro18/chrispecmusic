  ...
  app: {
    ...
    head: {
      ...
      link: [
        ...
        // Bootstrap comes from a third-party origin, so the browser pays a DNS
        // lookup plus TLS handshake before it can even start downloading.
      ...
      script: [
        // Deferred: it is not needed to paint, and without `defer` a
        ...
        //
        // The Font Awesome kit script used to sit here. Icons are now inline
        // SVGs rendered by components/AppIcon.vue, which drops a third-party
        // origin and the wait for that script before any icon could paint.
