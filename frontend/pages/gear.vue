...
const gearItems = ref([
  ...
  { name: 'Knilling Bucharest 1308T', type: 'Bass', image: '/img/gear/Knilling-Upright.png', description: 'Go-to for jazz sessions and acoustic sets.' },
  ...
  { name: 'Markbass New York 121', type: 'Cabinet', image: '/img/gear/Markbass-NewYork-121.png', description: 'Compact cab that still brings the warmth and punch. I own two of these for a flexible live sound options.' },
  ...
  { name: 'Electro-Voice RE20', type: 'Microphone', image: '/img/gear/EV-RE20.png', description: 'Versatile dynamic mic perfect for bass amps and vocals.' },
  ...
  { name: 'Audio-Technica AT4041', type: 'Microphone', image: '/img/gear/Audio-Technica-AT4041.png', description: 'Small-diaphragm condenser mic with a bright, detailed sound. Great for upright bass.' },
]);
